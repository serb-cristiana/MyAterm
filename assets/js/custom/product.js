  ...
  $("#btnAddNewAttributes").on('click',function(){
    ...
    if(attributes_value == '' || attributes_value == null){
      ...
      if($('#attributes_value').parent('div').find('.text-danger').length == 0) {
          $('#attributes_value').after('<span class="text-danger">Selectare valoare a atributului.</span>');
      }
      return false;
    }else {
    ...
    if(sold_as == '' || sold_as == null){
      ...
      if($('#sold_as').parent('div').find('.text-danger').length == 0) {
          $('#sold_as').after('<span class="text-danger">Selectați o unitate de măsură</span>');
      }
      return false;
    }else {
    ...
    if(price == '' || price == null){
      ...
      if($('#price').parent('div').find('.text-danger').length == 0) {
          $('#price').after('<span class="text-danger">Adăugați preț</span>');
      }
      return false;
    }else {
    ...
    if(inventory == '' || inventory == null){
      ...
      if($('#inventory').parent('div').find('.text-danger').length == 0) {
          $('#inventory').after('<span class="text-danger">Adăugați stoc</span>');
      }
      return false;
    }else {
    ...
    if(tax_rate == '' || tax_rate == null){
      ...
      if($('#tax_rate').parent('div').find('.text-danger').length == 0) {
          $('#tax_rate').after('<span class="text-danger">Selectați TVA</span>');
      }
      return false;
    }else {
