(function ($) {
    $.fn.pekeUpload = function (options) {
        ...
        var defaults = {
            ...
            allowedExtensions: "",
            invalidExtError: "Tip de fișier nevalid.",
            maxSize: 0,
            sizeError: "Dimensiunea fișierului este mai mare decât cea permisă.",
            showPreview: true,
            showFilename: true,
            showPercent: true,
            showErrorAlerts: true,
            errorOnResponse: "A apărut o eroare la încărcarea fișierului dvs.",
            onSubmit: false,
            url: "upload.php",
            data: null,
            limit: 1,
            limitError: "Ați atins limita de fișiere pe care le puteți încărca.",
            delfiletext: "Remove",
