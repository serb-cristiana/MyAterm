            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Listă Produse</h6>
                        <div class="dropdown no-arrow">
                          <a class="btn btn-outline-success btn-sm" href="<?=admin_url('products/add');?>" role="button">
                              <i class="fas fa-plus fa-sm"></i> Adaugă Produs
                          </a>
                        </div>
                    </div>
                    <!-- Card Body -->
                      ...
                      <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="myTable">
                            <thead style="background: #1ba774;color:#fff">
                                <tr>
                                    <th>Nr. crt.</th>
                                    <th id="image">Imagine</th>
                                    <th>Nume</th>
                                    <th>Categorie</th>
                                    <th>Brand</th>
                                    <th id="inventory">Stoc & Preț </th>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detalii despre produs</h5>
