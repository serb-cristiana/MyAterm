            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary"><?=$button;?>Produs</h6>
                    </div>
                    <!-- Card Body -->
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                          <div class=" col-md-6 form-group">
                            <label for="varchar"> Încărcare imagine <?php echo form_error('picture') ?></label>
                            <?php if($image_path){ ?>
                            <input type="file" name="image" id="image" data-error="Vă rugăm să încărcați imaginea." value="<?php echo $image_path; ?>" />
                            <br/><img src="<?php echo $image_path; ?>" class="img-responsive"  style="width:120px;height:100px;">

                            <?php }else{ ?>
                              <input type="file" name="image" id="image" data-error="Vă rugăm să încărcați imaginea produsului." value="<?php echo $image_path; ?>" />
                            <?php } ?>
                          </div>
                      </div>
                      <!-- attributes block -->
                      ...
                      <div class="row" >
                        ...
                        <button type="button" class="btn btn-success btn-sm btn-icon-split" data-toggle="modal" data-target="#myModal2">
                          <span class="icon text-white-50"><i class="fas fa-plus"></i></span><span class="text">Adăugare atribute</span>
                        </button>
        ...
        <!-- Modal -->
        	<div class="modal left fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
        		<div class="modal-dialog" role="document">
                  ...
                  <h4 class="modal-title" id="myModalLabel2">Adăugare atribute/preț</h4>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Valori ale atributelor</label>
