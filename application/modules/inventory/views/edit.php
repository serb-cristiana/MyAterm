                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                          <div class=" col-md-6 form-group">
                            ...
                            <input type="file" name="image" id="image" data-error="Vă rugăm să încărcați imaginea." value="<?php echo $edit_data[0]->image_path; ?>" />
                            <br/><img src="<?php echo $edit_data[0]->image_path; ?>" class="img-responsive"  style="width:120px;height:100px;">

                            <?php }else{ ?>
                              <input type="file" name="image" id="image" data-error="Vă rugăm să încărcați imaginea produsului." value="<?php echo $edit_data[0]->image_path; ?>" />
                            <?php } ?>
                          </div>
                      </div>
                      <!-- attributes block -->
