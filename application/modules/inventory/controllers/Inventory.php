...
class Inventory extends Admin_Controller
{
    ...
    {
        $this->layout->set_title('Detalii despre stocuri');
        $this->load_datatables();
        $this->breadcrumbs->admin_push('Dashboard', 'dashboard');
        $this->breadcrumbs->admin_push('Detalii despre stocuri', 'inventory');
    ...
    public function edit()
    {
      ...
      if($result){
        echo json_encode(array('message'=>'Stocul a fost actualizat cu succes.','type'=>'success'));
      }else {
